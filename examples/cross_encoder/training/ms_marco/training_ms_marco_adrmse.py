...
from sentence_transformers.cross_encoder.losses.ApproxDiscountedRankMSE import ApproxDiscountedRankMSE
...
def main():
    ...
    run_name = f"reranker-msmarco-v1.1-{short_model_name}-adrmse"
