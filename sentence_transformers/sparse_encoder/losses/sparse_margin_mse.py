...
class SparseMarginMSELoss(MarginMSELoss):
    def __init__(self, model: SparseEncoder, similarity_fct=util.pairwise_dot_score) -> None:
        ...
        to train. With SparseMultipleNegativesRankingLoss, with a batch size of 64, we compare one query against 128 documents.
        With SparseMarginMSELoss, we compare a query only against two documents. It's also possible to use multiple negatives
        ...
        Requirements:
            ...
            2. (query, document_one, document_two) triplets or (query, positive, negative_1, ..., negative_n)
